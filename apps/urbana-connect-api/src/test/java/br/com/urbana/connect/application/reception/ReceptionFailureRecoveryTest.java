...
class ReceptionFailureRecoveryTest {
    ...
    void returnsRetryableWithoutOutboundAndRetriesTheSameEventIdAfterTransientHermesFailure() {
        ...
        assertThat(capturedTurns.getAllValues().getLast().status())
                .isEqualTo(ReceptionTurnStatus.FAILED_SAFE_TO_RETRY);
        assertThat(capturedTurns.getAllValues().getLast().failureCode())
                .isEqualTo("HERMES_RETRYABLE_TRANSPORT");
